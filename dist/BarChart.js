...
var BarChart = /** @class */ (function (_super) {
    ...
    function BarChart() {
        ...
        _this.renderBars = function (_a) {
            var data = _a.data, width = _a.width, height = _a.height, paddingTop = _a.paddingTop, paddingRight = _a.paddingRight, barRadius = _a.barRadius, withCustomBarColorFromData = _a.withCustomBarColorFromData, onDataPointClick = _a.onDataPointClick;
            ...
            // ? "url(#customColor_0" + i + ")"
            // : "url(#fillShadowGradientFrom)"} onPress={onPress}/>);
            // });
            var baseHeight = _this.calcBaseHeight(data, height);
            return data.map(function (x, i) {
                var barHeight = _this.calcHeight(x, data, height);
                ...
                var onPress = function () {
                    ...
                    onDataPointClick({
                        ...
                        x:cx,
                        y: cy,
                    getColor: function (opacity) { return this.getColor(data[i], opacity); }
                    });
                };
    ...
    BarChart.prototype.render = function () {
        ...
        <Svg height={height} width={width}>
          ...
          <G>
            {this.renderBars(__assign(__assign({}, config), { data: data.datasets[0].data, paddingTop: paddingTop, paddingRight: paddingRight, withCustomBarColorFromData: withCustomBarColorFromData, onDataPointClick: onDataPointClick }))}
          </G>
          <G>
